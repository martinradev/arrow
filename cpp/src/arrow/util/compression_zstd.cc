...
class ZSTDCompressor : public Compressor {
 public:
  ZSTDCompressor(int32_t compression_level)
...
ZSTDCodec::ZSTDCodec(int32_t compression_level) : compression_level_(compression_level) {}
...
Status ZSTDCodec::Compress(int64_t input_len, const uint8_t* input,
                           int64_t output_buffer_len, uint8_t* output_buffer,
                           int64_t* output_len) {
  size_t ret = ZSTD_compress(output_buffer, static_cast<size_t>(output_buffer_len), input,
